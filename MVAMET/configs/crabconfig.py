...
def submission():
	...
	config = config()
	config.General.workArea = 'ekpbms1:/storage/jbod/nzaeh '%(getUsernameFromSiteDB(), date)
	...
	config.General.requestName = '/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIISpring16MiniAODv2-PUSpring16_80X_mcRun2_asymptotic_2016_miniAODv2_v0_ext1-v1/MINIAODSIM'#nickname[:100]
